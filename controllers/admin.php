...
$app->group('/admin', function () use ($app) {
    ...
    $app->group('/manage', function () use ($app) {
        ...
        $app->get('/', 'validateUser', function () use ($app) {
            ...
            $app->render(ADMIN_THEME . 'home.php', array('lang' => $lang,
                'jobs' => $jobs));
        });
    ...
    $app->group('/jobs', function () use ($app) {
        ...
        $app->get('/new', 'validateUser', function () use ($app) {
            ...
            $token = token();
            $app->render(ADMIN_THEME . 'job.new.php', array('lang' => $lang,
                'token' => $token,
                'markdown' => ACTIVE,
                'filestyle' => ACTIVE));
        });
        ...
        $app->get('/:id/publish/:token', 'validateUser', function ($id, $token) use ($app) {
            ...
            if (isset($job) && $job->id) {
                $app->render(ADMIN_THEME . 'job.publish.php', array('lang' => $lang,
                    'job' => $job,
                    'city' => $city,
                    'category' => $category));
            } else {
        ...
        $app->get('/:id/edit/:token', 'validateUser', function ($id, $token) use ($app) {
            ...
            if (isset($job) && $job->id) {
                $app->render(ADMIN_THEME . 'job.review.php', array('lang' => $lang,
                    'job' => $job,
                    'markdown' => ACTIVE,
                    'filestyle' => ACTIVE));
            } else {
        ...
        $app->get('/:id(/:title)', 'validateUser', function ($id, $title = null) use ($app) {
            ...
            if (isset($job) && $job->id) {
                $app->render(ADMIN_THEME . 'job.show.php', array('lang' => $lang,
                    'job' => $job,
                    'id' => $id,
    ...
    $app->group('/categories', function () use ($app) {
        ...
        $app->get('/:id(/:name(/:page))', 'validateUser', function ($id, $name = null, $page = 1) use ($app) {
            ...
            if (isset($categ) && $categ) {
                $app->render(ADMIN_THEME . 'categories.php', array('lang' => $lang,
                    'categ' => $categ,
                    'jobs' => $jobs,
                    'id' => $id,
    ...
    $app->group('/cities', function () use ($app) {
        ...
        $app->get('/:id(/:name(/:page))', 'validateUser', function ($id, $name = null, $page = 1) use ($app) {
            ...
            if (isset($city) && $city) {
                $app->render(ADMIN_THEME . 'cities.php', array('lang' => $lang,
                    'city' => $city,
                    'jobs' => $jobs,
                    'id' => $id,
                    'number_of_pages' => $number_of_pages,
    ...
    $app->group('/pages', function () use ($app) {
        ...
        $app->get('(/(:page))', 'validateUser', function ($page = 1) use ($app) {
            ...
            $app->render(ADMIN_THEME . 'pages.php', array('lang' => $lang,
                'pages' => $pages,
                'number_of_pages' => $number_of_pages,
                'current_page' => $page,
                'page_name' => 'pages'));
    ...
    $app->group('/blocks', function () use ($app) {
        ...
        $app->get('(/(:page))', 'validateUser', function ($page = 1) use ($app) {
            ...
            $app->render(ADMIN_THEME . 'blocks.php', array('lang' => $lang,
                'blocks' => $blocks,
                'number_of_pages' => $number_of_pages,
                'current_page' => $page,
                'page_name' => 'blocks'));
    ...
    $app->group('/ban', function () use ($app) {
        ...
        $app->get('(/(:page))', 'validateUser', function ($page = 1) use ($app) {
            ...
            $app->render(ADMIN_THEME . 'banlist.php', array('lang' => $lang,
                'list' => $list,
                'number_of_pages' => $number_of_pages,
                'current_page' => $page,
                'page_name' => 'banlist'));
    ...
    $app->group('/applications', function () use ($app) {
        ...
        $app->get('(/(:page))', 'validateUser', function ($page = 1) use ($app) {
            ...
            $app->render(ADMIN_THEME . 'applications.php', array('lang' => $lang,
                'applications' => $applications,
                'number_of_pages' => $number_of_pages,
                'current_page' => $page,
        ...
        $app->get('/jobs/:id(/:page)', 'validateUser', function ($id, $page = 1) use ($app) {
            ...
            $app->render(ADMIN_THEME . 'applications.job.php', array('lang' => $lang,
                'applications' => $applications,
                'number_of_pages' => $number_of_pages,
                'current_page' => $page,
                'page_name' => 'applications',
    ...
    $app->group('/subscribers', function () use ($app) {
        ...
        $app->get('(/(:page))', 'validateUser', function ($page = 1) use ($app) {
            ...
            $app->render(ADMIN_THEME . 'subscribers.php', array('lang' => $lang,
                'users' => $users,
                'number_of_pages' => $number_of_pages,
                'current_page' => $page,
                'count' => $count,
